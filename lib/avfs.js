...
AVfS.Map = {
  "default":{
    "texture":AVfS.Pref.texture_dir + 'world_topo_bathy_200404_3x4096x2048.jpg',
  ...
  "fire_20120321":{
    "texture":AVfS.Pref.texture_dir + 'global_fire_map_201203.jpg',
  ...
  "chlorophyll_2002":{
    "texture":'textures/global_chlorophyll_concentrations.jpg',
  ...
  "asst_2003":{
    "texture":'textures/average_sea_surface_temperature_2003.jpg',
  ...
  "chlorophyll_2006":{
    "texture":'textures/global_chlorophyll_concentrations_2006_spring',
  ...
  "global_ecco2":{
    "texture":'textures/global_ecco2.jpg',
  ...
  "coud_fraction_201203":{
    "texture":'textures/coud_fraction_201203.jpg',
  ...
  "forest_height_2012":{
    "texture":'textures/global_forest_height_2012',
...
AVfS.StartUp = function(){
  ...
  var texture = AVfS.Map[id].texture;
  ...
  if(q["texture"]){
    var texture = AVfS.Pref.texture_dir + q["texture"] + '.jpg';
  }
...
AVfS.TLELoader = function(){
  ...
  var data = AVfS.Tool.DataLoader({
    ajax:false,
    format:"text",
    path:AVfS.Pref.tle_dir + "iss.txt",
  })
