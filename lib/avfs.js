...
AVfS.SetPlot = function(){
  if(AVfS.Plot.Default == undefined){
     AVfS.Plot.Default = AVfS.JSONLoader("default","plot");
  }
}

AVfS.SetArticle = function(){
if(AVfS.Article.Default == undefined){
   AVfS.Article.Default = AVfS.JSONLoader("default","article");
}
if(AVfS.Article.Regional == undefined){
   AVfS.Article.Regional = AVfS.JSONLoader("regional","article");
}
/*
